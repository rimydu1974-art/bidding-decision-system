...
assessment = {
    ...
    "qualificationRequirements": [
        {
            ...
            "creditRequirements": "通过"信用中国"网站和中国政府采购网查询信用记录",
    ...
    "projectInfo": {
        "substantialRequirements": "★项为重要服务要求或配套产品技术参数，如有负偏离每项扣3分",
        "deviationResult": "★项负偏离可能导致较大扣分",
        "drawingsProvided": "招标文件未提及",
        "drawingList": "招标文件未提及",
        "drawingDepthRequirement": "招标文件未提及",
        "siteSurveyRequired": "招标文件未提及",
        "siteSurveyConfirmation": "招标文件未提及",
        ...
        "projectOutcomeRequirements": "7个展项的数字展示内容及相关配套",
        "finalDelivery": "通过项目验收",
        "specialProjectPoints": "需提供15分钟讲解视频、成功样片、展陈样片",
        "originalCopies": "招标文件未明确",
        "bidSubmissionMarking": "招标文件未明确",
    ...
    "phoneQuestions": [
        ...
        {
            "question": "7个展项的技术参数中★项具体有哪些？需要提供哪些检测报告？",
            "reason": "招标文件提到★项扣分但未列出具体哪些是★项",
            "priority": "high",
            "category": "技术"
        },
        {
...
print(f'  风险等级: {assessment["risks"][0]["level"]}')
